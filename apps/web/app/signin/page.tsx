...
function SignInInner() {
  ...
  // Credentials and magic link removed; OAuth only

  return (
    <div
      className="mx-auto flex min-h-[70vh] w-full max-w-xl flex-col items-center justify-center gap-6"
      onPointerMove={(e) => setMouse({ x: e.clientX, y: e.clientY })}
      onPointerLeave={() => setMouse(null)}
    >
      <div className="flex flex-col items-center">
        <Image src="/logo.svg" alt="craft_cost" width={220} height={160} priority />
      </div>
